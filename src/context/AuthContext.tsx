...
import api, { ACCESS_TOKEN_KEY, REFRESH_TOKEN_KEY, registerSessionExpiredCallback } from '@/lib/axios';
            ...
            content: (props) => (
                <div className="flex flex-column align-items-start" style={{ flex: '1' }}>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            logout();
                            // Manually clear the toast if needed, though logout redirects
                            // props.message.sticky is true, so it stays until action
                        }}
                    />
                </div>
            )
