...
interface ProtagonistaFormDialogProps {
  ...
  error: string;
  onHide: () => void;
  onSubmit: (values: ProtagonistaFormValues) => void;
}

export function ProtagonistaFormDialog({
  visible,
  mode,
  loading,
  submitting,
  ...
  onHide,
  onSubmit,
}: ProtagonistaFormDialogProps) {
  const {
    control,
    handleSubmit,
    reset,
    formState: { errors },
  } = useForm<ProtagonistaFormValues>({
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Controller
              name="idRama"
              control={control}
              rules={{ required: 'Debes seleccionar una rama.' }}
              render={({ field }) => (
                <Dropdown
                  id="rama"
                  value={field.value}
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="fechaIngresoRama">Ingreso a rama</label>
            <Controller
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="esBecado">Becado</label>
          </div>
